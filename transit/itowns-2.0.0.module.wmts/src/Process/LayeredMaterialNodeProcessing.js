import { l_ELEVATION, l_COLOR, EMPTY_TEXTURE_ZOOM } from '../Renderer/LayeredMaterial.js';
import { chooseNextLevelToFetch } from '../Core/Layer/LayerUpdateStrategy.js';
import LayerUpdateState from '../Core/Layer/LayerUpdateState.js';
import { ImageryLayers } from '../Core/Layer/Layer.js';
import { CancelledCommandException } from '../Core/Scheduler/Scheduler.js';
import OGCWebServiceHelper, { SIZE_TEXTURE_TILE } from '../Core/Scheduler/Providers/OGCWebServiceHelper.js';
