...
import MathExt from '../Core/Math/MathExtended.js';
import SchemeTile from '../Core/Geographic/SchemeTile.js';
import { UNIT, ellipsoidSizes } from '../Core/Geographic/Coordinates.js';
import { SIZE_TEXTURE_TILE } from '../Core/Scheduler/Providers/OGCWebServiceHelper.js';
