...
import Camera2DController from './Camera2DController.js';
import CameraFlightController from './CameraFlightController.js';
import CameraSpindleController from './CameraSpindleController.js';
import CameraFreeLookController from './CameraFreeLookController.js';
import CameraColumbusViewController from './CameraColumbusViewController.js';
 ...
 */
export default function CameraControllerCollection(camera, canvas) {
	this._controllers = [];
	this._canvas = canvas;
	this._camera = camera;
}
